...
public class RedisUtils {
    ...
    public void del(String... key) {
        if (key != null && key.length > 0) {
            if (key.length == 1) {
                ...
                redisTemplate.delete(Collections.arrayToList(key));
            }
        }
    }
    ...
    public boolean set(String key, Object value, long time) {
        try {
            ...
            log.error("redisUtils set time error: {}", e);
            return false;
        }
    }
    ...
    public boolean setNxPx(String key, String value, long time) {
         return redisTemplate.execute((RedisCallback<Boolean>) con ->
                con.set(key.getBytes(), value.getBytes(), Expiration.milliseconds(time)
    ...
    public boolean hmset(String key, Map<String, Object> map, long time) {
        try {
            ...
            log.error("redisUtils hmset time error: {}", e);
            return false;
        }
    }
    ...
    public boolean hset(String key, String item, Object value, long time) {
        try {
            ...
            log.error("redisUtils hset time error: {}", e);
            return false;
        }
    }
    ...
    public long sGetSetSize(String key) {
        try {
            ...
            log.error("redisUtils sGetSetSize error: {}", e);
            return 0;
        }
    }
    ...
    public List<Object> lGet(String key, long start, long end) {
        try {
            ...
            log.error("redisUtils lGet start end error: {}", e);
            return null;
        }
    }
    ...
    public boolean lSet(String key, Object value) {
        try {
            ...
            log.error("redisUtils lSet Object error: {}", e);
            return false;
        }
    }
    ...
    public boolean lSet(String key, Object value, long time) {
        try {
            ...
            log.error("redisUtils lSet Object time error: {}", e);
            return false;
        }
    }
    ...
    public boolean lSet(String key, List<Object> value) {
        try {
            ...
            log.error("redisUtils lSet List error: {}", e);
            return false;
        }
    }
    ...
    public boolean lSet(String key, List<Object> value, long time) {
        try {
            ...
            log.error("redisUtils lSet List time error: {}", e);
            return false;
        }
    }
